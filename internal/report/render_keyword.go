...
func renderLabels(r *pdfReportRenderer, k KeywordReportData) {
	...
	r.note("Label method note: manual labels come from the user's label-name input. Auto-identify checks existing row label_name, then the best alias candidate, then gene/transcript/sequence identifiers.")
